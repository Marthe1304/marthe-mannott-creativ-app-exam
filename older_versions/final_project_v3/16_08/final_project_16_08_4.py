...
def generate_image(image_list, appending_list, weight, decay_list):
    ...
    for n in range(len(image_list)):
        ...
        if appending_list[n] == 0:
            new_image_list.append(0)

        elif appending_list[n] == 8:
            new_image_list.append(1)

        elif appending_list[n] == 7: #7
            new_image_list.append(image_list[n])

        elif appending_list[n] == 6: #6
            new_image_list.append(1)

        elif appending_list[n] >= 5: #5-3
            if decay_list[n] == 0:
                new_image_list.append(0)
            else:
                new_image_list.append(image_list[n])

        elif appending_list[n] >= 2:  #2-1
            if decay_list[n] == 0:
                new_image_list.append(1)
            else:
                new_image_list.append(image_list[n])
        else:
            new_image_list.append(image_list[n]) # eigentlich nicht nötig, aber zur sicherheit
...
new_image.save(f"/Users/macmannott/Documents/creative_applications/final_project_v3/16_08/Images/image_0.png")
